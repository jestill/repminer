...
#    }
	...
	#-----------------------------+
	# OPEN OUTPUT FASTA FILE FILE |
	#-----------------------------+
	# A separate fasta file for each cluster
	# This requires that the information for the fasta file
	# exists in the expected location in the MySQL database
	...
	for my $IndComp (@$ComList)
	{
	    ...
	    # FROM DATABASE AND WRITE TO  |
	    # OUTFILE                     |
	    #-----------------------------+
	    # These currently use the rownum for the id, not 
	    # very sustainable ... should use the a more
	    # specific SeqId
...
#    - Added Fasta file output for clusters
